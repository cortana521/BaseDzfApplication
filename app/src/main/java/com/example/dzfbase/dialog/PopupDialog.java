package com.example.dzfbase.dialog;
...
public class PopupDialog extends AlertDialog {
    ...
    private void setDialogTitle(CharSequence title, boolean closeBtn) {
    ...
    private void setDialogMessage(CharSequence msg) {
    ...
    private void setDialogButton(String confirm, View.OnClickListener positiveClickListener, String cancel, View
     ...
     * @param cancelable             按回车键时取消
     * @param canceledOnTouchOutside 取消对外联系
     ...
     * @param messageRes             对话框消息的资源id，如果不需要内容，则传递0
     * @param confirmRes             对话框的确认按钮的资源id，如果不需要标题，则传递0
     * @param positiveClickListener  单击确认按钮的侦听器
     * @param cancelRes              对话框的cancel按钮的资源id，如果不需要标题，则传递0
     * @param negativeClickListener  单击“取消”按钮的侦听器
     * @param cancelable             按回车键时取消
     * @param canceledOnTouchOutside 取消对外联系
     * @param closeBtn               是否显示关闭按钮
